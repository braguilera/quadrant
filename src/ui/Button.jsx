...
const Button = ({ onClick, children, variant = 'primary', className = '' }) => {
  ...
  const variantStyles = {
    primary: "bg-secondary rounded-xl text-primary hover:bg-primary hover:text-white shadow-lg",
    outline: "bg-transparent border-2 border-secondary text-secondary hover:bg-secondary hover:text-primary",
    outlineNav: "bg-transparent border-2 border-white text-white hover:bg-secondary hover:text-primary",
